...
def thread_job(t_hash):
    ...
    d_thread = {}
    h1 = Thread(target=pfit.main, args=(hash_times[t_hash[0]], 3))
    h2 = Thread(target=pfit.main, args=(hash_times[t_hash[1]], 3))
    h3 = Thread(target=pfit.main, args=(hash_times[t_hash[2]], 3))
    h4 = Thread(target=pfit.main, args=(hash_times[t_hash[3]], 3))
